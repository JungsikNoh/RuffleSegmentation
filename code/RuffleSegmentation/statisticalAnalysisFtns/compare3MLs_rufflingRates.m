...
rootDir = fullfile('/endosome/archive/bioinformatics/Danuser_lab/Ras/ImagesandData', ...
    '/analysis/jungsik/20230502_ActinPerturbations/Tractin-mRuby2/CK666/COR-L23/202602_toDeployRufflingRateQuantification/08262023-subset');

outputname = 'ML_compare';
outputDir = fullfile(rootDir, 'ML_compare_02192026');
...
cond1MLdir = fullfile(rootDir, condName{1}, 'ML');
cond2MLdir = fullfile(rootDir, condName{2}, 'ML');
cond3MLdir = fullfile(rootDir, condName{3}, 'ML');
